    ...
    private void btnCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCadastrarMouseClicked
        ...
        if(nome.isEmpty() || cpf.isEmpty() || telefone.isEmpty() || email.isEmpty() || rua.isEmpty() || numero.isEmpty() || cep.isEmpty() || login.isEmpty() || senha.isEmpty() || confSenha.isEmpty()){
            ...
            if(senha.equals(confSenha)){
                ...
                cadastroFuncionarioController.incluirUsuario(usuarioModel);
                ...
                cadastroFuncionarioController.incluirEndereco(enderecoModel);

                // Pegar id do Endereco
                int id_endereco = cadastroFuncionarioController.buscarIdEndereco(enderecoModel);

                // Variável que vai armazenar o valor do id do usuario
                int id_usuario = cadastroFuncionarioController.buscarIdUsuario(usuarioModel);
                ...
                cadastroFuncionarioController.incluirFuncionario(funcionarioModel, id_endereco, id_usuario);
